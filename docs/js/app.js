...
var setAnotherImage = function (image) {
  ...
  lightboxActualNumber.innerText = "".concat(image);
};

lightboxAllImages.forEach(function (image, index) {
  image.addEventListener("click", function () {
    lightboxImage.setAttribute("src", image.getAttribute("src"));
    lightboxModal.style.display = "flex";
    lightboxActualNumber.innerText = "".concat(index + 1);
    lightboxAllNumber.innerText = "".concat(lightboxAllImages.length);
  });
});
...
lightboxPrevBtn.addEventListener("click", function () {
  var actualImage = parseInt(lightboxActualNumber.innerText);
